...
{
    scope.ServiceProvider.GetRequiredService<PassengerDbContext>().Database.Migrate();
}

// Middleware Pipeline
app.UseSwagger();
app.UseSwaggerUI(options => options.SwaggerEndpoint("/swagger/v1/swagger.json", "SkyBooker-PassengerService v1"));
